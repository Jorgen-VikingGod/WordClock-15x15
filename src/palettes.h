...
const TProgmemRGBPalette16 RedGreenWhite_p FL_PROGMEM = {
    ...
    CRGB::Red, CRGB::Red, CRGB::Gray, CRGB::Gray, CRGB::Green, CRGB::Green, CRGB::Green, CRGB::Green};
...
const TProgmemRGBPalette16 FairyLight_p FL_PROGMEM = {
    CRGB::FairyLight, CRGB::FairyLight, CRGB::FairyLight, CRGB::FairyLight, HALFFAIRY,        HALFFAIRY,
    CRGB::FairyLight, CRGB::FairyLight, QUARTERFAIRY,     QUARTERFAIRY,     CRGB::FairyLight, CRGB::FairyLight,
...
const TProgmemRGBPalette16 IcyBlue_p FL_PROGMEM = {Ice_Blue1, Ice_Blue1, Ice_Blue1, Ice_Blue1, Ice_Blue1, Ice_Blue1,
...
const CRGBPalette16 palettes[] = {
    ...
    Blue_Cyan_Yellow_gp,
    Black_Green_Striped_gp,
    Black_White_Striped_gp,
};
